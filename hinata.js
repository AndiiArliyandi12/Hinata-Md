...
module.exports = hinata = async (hinata, m, chatUpdate, store) => {
    try {
        ...
        var prefix = prefa ? /^[°あπ÷×¶∆£¢€¥®™+✓_=|~!?@#$%^&.©^]/gi.test(body) ? body.match(/^[°あπ÷×¶∆£¢€¥®™+✓_=|~!?@#$%^&.©^]/gi)[0] : "" : prefa ?? global.prefix
...
Selama ${clockString(new Date - user.afkTime)}`)
	    ...
	    case 'donasi': case 'donate': {
                m.reply(`Don't forget to donate\n\nSaweria\nあ ${global.donasi.saweria}\n\n(Dana/Gopay/Pulsa)\nあ ${global.donasi.nomor}\n\nThank you!`)
            }
            break
            case 'sc': {
...
あ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                hinata.sendImage(m.chat, media.thumb, `あ Title : ${media.title}\nあ File Size : ${media.filesizeF}\nあ Url : ${isUrl(text)}\nあ Ext : MP3\nあ Resolusi : ${args[1] || '128kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                hinata.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `あ Title : ${media.title}\nあ File Size : ${media.filesizeF}\nあ Url : ${isUrl(text)}\nあ Ext : MP3\nあ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
		...
		let { pinterest } = require('./lib/scraper')
                ...
                hinata.sendMessage(m.chat, { image: { url: result }, caption: 'あ Media Url : '+result }, { quoted: m })
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `あ *Nama :* ${anu.message.nama}\nあ *Arti :* ${anu.message.arti}\nあ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `あ *Tanggal Pernikahan :* ${anu.message.tanggal}\nあ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        hinata.sendMessage(m.chat, { image: { url }, caption: `あ Title : ${anu.title}\nあ Author : ${anu.author.name}\nあ Like : ${anu.like}\nあ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
